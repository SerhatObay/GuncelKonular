...
public class QuizGameLevel3 : MonoBehaviour
{
    ...
    void newQuestion()
    {
        ...
        for (int i = 0; i < answers.Length; i++)
        {
            ...
            {
                case 1:
                    answersInEnglish[i] = "BİR";
                    break;
                case 2:
                    answersInEnglish[i] = "İKİ";
                    break;
                case 3:
                    answersInEnglish[i] = "ÜÇ";
                    break;
                case 4:
                    answersInEnglish[i] = "DÖRT";
                    break;
                case 5:
                    answersInEnglish[i] = "BEŞ";
                    break;
                case 6:
                    answersInEnglish[i] = "ALTI";
                    break;
                case 7:
                    answersInEnglish[i] = "YEDİ";
                    break;
                case 8:
                    answersInEnglish[i] = "SEKİZ";
                    break;
                case 9:
                    answersInEnglish[i] = "DOKUZ";
                    break;
                case 10:
                    answersInEnglish[i] = "ON";
                    break;
    ...
    IEnumerator ContinueAfterFeedback()
    {
        ...
        questionsDone++;
        scoreText.text = "sonuç: " + score.ToString() + "/" + questionsDone.ToString();
